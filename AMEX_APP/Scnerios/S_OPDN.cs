...
{
    public partial class S_OPDN : Form
    {
        private const string TRANSACTIONLOG = "Armada_Service_M_S_OPDN_s";
        ...
        private void S_OPDN_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void LoadAll()
        {
            try
            {
                ...
                string str_M_S_ORIN = "Exec Armada_Service_M_S_OPDN_s";
