                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                Select Case pVal.ItemUID
                                    ...
                                    Case "18_"
                                        oApplication.Utilities.OpenFileDialogBox(oForm, "18")
                                End Select
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_CHOOSE_FROM_LIST
                                oForm = oApplication.SBO_Application.Forms.Item(FormUID)
                                alldataSource(oForm)
                                oDBDataSource = oForm.DataSources.DBDataSources.Item("@Z_AMX_IBND")
                                    ...
                                    If Not oForm.Mode = SAPbouiCOM.BoFormMode.fm_FIND_MODE Then
                                        If pVal.ItemUID = "15" Then
                                            ...
                                            If intAddRows > 0 Then
                                                oDBDataSource.SetValue("U_DSUSACCT", 0, oDataTable.GetValue("AcctCode", 0))
                                            End If
                                            If oForm.Mode = SAPbouiCOM.BoFormMode.fm_OK_MODE Then oForm.Mode = SAPbouiCOM.BoFormMode.fm_UPDATE_MODE
                                        ElseIf pVal.ItemUID = "16" Then
                                            ...
                                            End If
                                            If intAddRows > 0 Then
                                                oDBDataSource.SetValue("U_CSUSACCT", 0, oDataTable.GetValue("AcctCode", 0))
                                            End If
                                            If oForm.Mode = SAPbouiCOM.BoFormMode.fm_OK_MODE Then oForm.Mode = SAPbouiCOM.BoFormMode.fm_UPDATE_MODE
                                        End If
                                    End If
...
#End Region
    ...
    Private Sub initialize(ByVal oForm As SAPbouiCOM.Form)
        Try
            ...
            oRecordSet.DoQuery("Select IsNull(MAX(DocEntry),0) +1 From [@Z_AMX_IBND]")
    ...
    Private Sub loadSeries(ByVal oForm As SAPbouiCOM.Form)
        Try
            ...
            strQuery = "Select Series,SeriesName,IsManual,Locked From NNM1 Where ObjectCode = '30' "
    ...
    Private Function validation(ByVal aForm As SAPbouiCOM.Form) As Boolean
        Try
            ...
            If oForm.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
                strQuery = "Select 1 As 'Return',DocEntry From [@Z_AMX_IBND]"
                strQuery += " Where "
